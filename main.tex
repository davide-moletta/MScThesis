...
\begin{document}
  ...
  \input{chapters/3_riscv.tex}
  \input{chapters/4_project.tex}
  \input{chapters/5_security_analysis.tex}
  \input{chapters/6_performance_analysis.tex}
  \input{chapters/7_freertos.tex}
